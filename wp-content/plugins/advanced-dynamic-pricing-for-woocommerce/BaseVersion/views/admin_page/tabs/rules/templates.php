...
<div id="templates" style="display: none;">
    ...
    <div id="filter_item_qty_template">
        <div class="wdp-row wdp-filter-item" data-index="{f}">
            ...
            <div class="wdp-filter-content-no-remove">
			    ...
			    foreach ( \ADP\BaseVersion\Includes\Common\Helpers::get_custom_product_taxonomies() as $tax ) {
                        ...
                        <div>
							<div class="wdp-limitation" style="margin-top: 10px">
                                <select name="rule[{t}][{f}][limitation]">
                                    <option value="<?php echo PackageItem::LIMITATION_NONE; ?>"><?php _e( 'None', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
                                    <option value="<?php echo PackageItem::LIMITATION_SAME_PRODUCT; ?>"><?php _e( 'Same product only', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
                                    <option value="<?php echo PackageItem::LIMITATION_UNIQUE_PRODUCT; ?>"><?php _e( 'Unique product only', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
                                    <option value="<?php echo PackageItem::LIMITATION_SAME_VARIATION; ?>"><?php _e( 'Same variation only', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
                                    <option value="<?php echo PackageItem::LIMITATION_UNIQUE_VARIATION; ?>"><?php _e( 'Unique variation only', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
                                    <option value="<?php echo PackageItem::LIMITATION_SAME_HASH; ?>"><?php _e( 'Only same hash', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
                                    <option value="<?php echo PackageItem::LIMITATION_UNIQUE_HASH; ?>"><?php _e( 'Only unique hash', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
                                </select>
                            </div>
                        </div>
	...
	<?php foreach ( \ADP\BaseVersion\Includes\Common\Helpers::get_custom_product_taxonomies() as $tax ): ?>
