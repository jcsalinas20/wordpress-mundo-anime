...
class CouponCartItem implements Coupon {
	 ...
	 * @param WcCartItemFacade $affectedCartItem
	 */
	public function __construct( $context, $type, $code, $value, $ruleId, $affectedCartItem ) {
