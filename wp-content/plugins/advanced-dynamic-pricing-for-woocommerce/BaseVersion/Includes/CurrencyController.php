...
class CurrencyController {
	...
	public function getDefaultCurrencyProductRegularPrice( $product ) {
		...
		if ( $this->customProductRegularPriceCallback ) {
			return call_user_func( $this->customProductRegularPriceCallback, $regularPrice, $product, $this->defaultCurrency );
		}
	...
	public function getCurrentCurrencyProductRegularPrice( $product ) {
		...
		if ( $this->customProductRegularPriceCallback ) {
			return call_user_func( $this->customProductRegularPriceCallback, $regularPrice, $product, $this->currentCurrency );
		}
