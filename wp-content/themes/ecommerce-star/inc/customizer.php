...
function ecommerce_star_customizer_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'ecommerce_star_lite' , array(
			'title'      	=> __( 'Pro Features', 'ecommerce-star' ),
			'priority' => 1,
		) );
...
require_once ECOMMERCE_STAR_TEMPLATE_DIR.'/inc/customizer/popup-cart.php';
require_once ECOMMERCE_STAR_TEMPLATE_DIR.'/inc/customizer/layout.php';
require_once ECOMMERCE_STAR_TEMPLATE_DIR.'/inc/customizer/button.php';
